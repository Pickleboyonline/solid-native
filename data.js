(() => {
  ...
  // ../../../Library/Caches/deno/deno_esbuild/solid-js@1.8.17_seroval@1.0.7/node_modules/solid-js/dist/solid.js
  var sharedConfig = {
    context: void 0,
    registry: void 0
  };
  ...
  // ../../../Library/Caches/deno/deno_esbuild/solid-js@1.8.17_seroval@1.0.7/node_modules/solid-js/universal/dist/universal.js
  ...
  // packages/core/modules/solid_native_renderer.ts
  var SolidNativeRenderer = getNativeModule(
    "_SolidNativeRenderer"
  );

  // packages/core/renderer.ts
  var wrappedNodeMap = /* @__PURE__ */ new Map();
  var wrapNodeIdInNode = (id) => {
  ...
  var {
    ...
    insertNode({ id: parentId }, { id: nodeId }, anchor) {
      const anchorId = anchor == null ? void 0 : anchor.id;
  ...
  // packages/core/views/view.tsx
  function View(props) {
    return (() => {
      var _el$ = createElement("sn_view");
      spread(_el$, props, false);
      return _el$;
    })();
  }

  // packages/core/lib/print.ts
  var print = globalThis._print;

  // packages/core/lib/get_native_module.ts
  function getNativeModule(moduleName) {
    const mod = globalThis[moduleName];
    return mod;
  }

  // packages/test_app/src/DuktapeApp.tsx
  function DukatapeApp() {
