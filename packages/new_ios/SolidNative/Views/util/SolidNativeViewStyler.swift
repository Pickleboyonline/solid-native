...
public class SolidNativeViewStyler {
    // TODO: Impliment basic view styles like background color, opacity, etc...
    static func applyViewStyles() {
        
    }
    
    
    // TODO: Make this into a view modifier
    static func applyLayoutStyles(
